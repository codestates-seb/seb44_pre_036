...
| <div style="display: flex; align-items: flex-start;"><span><a href="https://github.com/minsun0714">@minsun0714</a></span><br/><span>로그인, 회원가입 구현</span></div> | <div style="display: flex; align-items: flex-start;"><span><a href="https://github.com/seobi-97">@seobi-97</a></span><br/><span>GSB, GNB, Footer, Router, 답변(Answer) 구현</span></div> | <div style="display: flex; align-items: flex-start;"><span><a href="https://github.com/Mooobi">@Mooobi</a></span><br/><span>질문리스트 CRUD 구현</span></div> |
...
|   🙈    | .gitignore에 파일 추가 |
|   💄    | 컴포넌트 생성, CSS 등 사용자 UI 디자인 변경 |
|   💡    | 필요한 주석 추가 및 변경 |
|   🚚    | 파일 또는 폴더 명을 수정하거나 옮기는 작업만인 경우 |
|   🔥    | 파일 or 폴더 or 코드를 삭제하는 작업만 수행한 경우 |
|  👽️   | API 변경의 경우 |
|   🚑    | hotfix |
|   🗃️    | DB 관련 변경 사항 |
|   ⚡️    | 성능 개선 |
